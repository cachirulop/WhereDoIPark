...
public class MapFilesManager
{
     ...
     * 
     * Synchronize the map files in then local storage with the data in
     * the database.
     *     
     * First read the new files of the local storage and add or update the
     * of them.
     *     
     ...
     * creation date. If it has the same date as the register in the database
     * do nothing, else update its data with the new file.
     * If the file doesn't exist insert new record in the table.
     * 
     */
     ...
     * 
     * Read the list of files in the database table and remove those that doesn't 
